...
namespace altar { namespace cuda { namespace extensions {
        ...
        namespace cudaUniformLogit {
            ...
            // sample in sampling space
            // use cudaLogistic::sample instead - identical sampling process
            ...
            // compute gradient of log pdf
            extern const char * const logpdfgradient__name__;
            extern const char * const logpdfgradient__doc__;
            PyObject * logpdfgradient(PyObject *, PyObject *);

            // compute jacobian matrix
            extern const char * const jacobian__name__;
            extern const char * const jacobian__doc__;
            PyObject * jacobian(PyObject *, PyObject *);
        }
