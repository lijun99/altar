...
module(py::module & m)
{
    ...
    py::class_<pyRateDependent_double>(m, "model_double")
        ...
        .def("set_spinup_data", &pyRateDependent_double::set_spinup_data)
        .def("forward_model", &pyRateDependent_double::forward_model);
    py::class_<pyRateDependent_float>(m, "model_float")
        .def(py::init())
        .def("initialize", &pyRateDependent_float::initialize)
        .def("set_spinup_data", &pyRateDependent_float::set_spinup_data)
        .def("forward_model", &pyRateDependent_float::forward_model);
}
